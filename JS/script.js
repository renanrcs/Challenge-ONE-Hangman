...
const divButtons =  document.getElementById("div-buttons-start");
const divAddWord = document.getElementById("div-addWord");

//vetor de palavras a serem usadas no jogo
let words = ["angular", "spring", "calopsita", "javascript", "java"];
let letters = [];
        ...
        if(checkLetter(letter) && secretWord.includes(letter)){
            ...
            switch (errors) {
                ...
                case 0:
                    ...
                    alert(`Você perdeu! Palavra correta: ${secretWord}`);
                    break;
